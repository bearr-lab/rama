    ...
    <section className="relative w-full overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
        ...
        >
          <Badge
            variant="outline"
            className="inline-flex items-center gap-2 rounded-none border-stone-300/50 bg-background/60 px-4 py-1.5 text-xs tracking-[0.2em] text-foreground/70 uppercase backdrop-blur dark:border-stone-800/50"
          >
            UI TripleD
            <span
        ...
        >
          <motion.article
            ...
            className="group relative col-span-1 flex h-full flex-col justify-between overflow-hidden rounded-none border border-stone-300/40 bg-background/70 p-6 backdrop-blur transition-all hover:border-stone-300/60 hover:shadow-lg sm:col-span-2 lg:row-span-2 dark:border-stone-800/60"
            role="article"
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div className="space-y-4">
                <Badge
                  variant="secondary"
                  className="w-fit rounded-none border-stone-300/40 bg-background/80 px-3 py-1 text-xs tracking-[0.2em] text-foreground/70 uppercase dark:border-stone-800/40"
                >
                  Featured case study
                </Badge>
                ...
                >
                  {avatarProfiles.map((profile) => (
                    <div
                      key={profile.src}
                      role="listitem"
                      className="relative size-11 overflow-hidden rounded-none border border-stone-300/50 bg-background/80 transition-opacity duration-300 group-hover:opacity-80 dark:border-stone-800/50"
                    >
                      <img
                        src={profile.src}
                        alt={profile.alt}
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group col-span-1 flex h-full flex-col rounded-none border border-stone-300/40 bg-background/70 p-6 backdrop-blur transition-all hover:border-stone-300/60 hover:shadow-lg sm:col-span-2 dark:border-stone-800/60"
            role="article"
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              {keyMetrics.map((metric) => (
                <div key={metric.label} className="">
                  ...
                  <p className="mt-1 inline-flex items-center gap-2 px-2 py-1 text-xs font-semibold text-stone-800 dark:text-stone-100">
                    {metric.caption}
                  </p>
                </div>
              ))}
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group relative col-span-1 overflow-hidden rounded-none border border-stone-300/40 bg-background/70 backdrop-blur hover:border-stone-300/60 hover:shadow-lg sm:col-span-2 lg:row-span-3 dark:border-stone-800/60"
            role="article"
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-end space-y-4 p-6 md:p-8">
              <Badge
                variant="outline"
                className="w-fit rounded-none border-stone-300/60 bg-background/80 px-3 py-1 text-xs tracking-[0.2em] text-foreground/70 uppercase dark:border-stone-800/60"
              >
                Behind the scenes
              </Badge>
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {['Micro-interactions', 'Depth cues', 'Narrative flow'].map(
                  (tag) => (
                    <span
                      key={tag}
                      className="rounded-none border border-stone-300/40 bg-background/70 px-3 py-1 text-xs tracking-[0.18em] text-foreground/60 uppercase dark:border-stone-800/40"
                    >
                      {tag}
                    </span>
                  ),
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group col-span-1 flex h-full flex-col rounded-none border border-stone-300/40 bg-background/70 p-6 backdrop-blur transition-all hover:border-stone-300/60 hover:shadow-lg sm:col-span-2 lg:row-span-2 dark:border-stone-800/60"
            role="article"
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group col-span-1 flex h-full flex-col overflow-hidden rounded-none border border-stone-300/40 bg-linear-to-r from-primary/15 via-background/70 to-background/90 p-0 backdrop-blur transition-all hover:border-stone-300/60 hover:shadow-lg sm:col-span-2 dark:border-stone-800/60"
            role="article"
              ...
              <div className="relative flex h-full flex-col justify-between bg-linear-to-r from-background/90 via-background/70 to-transparent p-6 md:p-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <Badge
                      variant="outline"
                      className="w-fit rounded-none border-stone-300/50 bg-background/70 px-3 py-1 text-xs tracking-[0.2em] text-foreground/70 uppercase dark:border-stone-800/50"
                    >
                      Motion showcase
                    </Badge>
                    <motion.div
          ...
          >
            <div className="space-y-3">
              <Badge
                variant="outline"
                className="w-fit rounded-none border-stone-300/50 bg-background/70 px-3 py-1 text-xs tracking-[0.2em] text-foreground/60 uppercase dark:border-stone-800/50"
              >
                Visual research
              </Badge>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {inspirationGallery.map((image) => (
                <div
                  key={image.src}
                  className="relative aspect-4/3 overflow-hidden rounded-none border border-stone-300/30 bg-background/60 dark:border-stone-800/30"
                >
                  <img
                    src={image.src}
                    alt={image.alt}
