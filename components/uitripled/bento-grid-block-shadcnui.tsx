    ...
    <section className="relative w-full overflow-hidden bg-background">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
        ...
        >
          <Badge
            variant="outline"
            className="border-border/50 inline-flex items-center gap-2 rounded-none bg-background/60 px-4 py-1.5 text-xs tracking-[0.2em] text-foreground/70 uppercase backdrop-blur "
          >
            UI TripleD
            <span
        ...
        >
          <motion.article
            ...
            className="group border-border/40 hover:border-border/60 relative col-span-1 flex h-full flex-col justify-between overflow-hidden rounded-none border bg-background/70 p-6 backdrop-blur transition-all hover:shadow-lg sm:col-span-2 lg:row-span-2 "
            role="article"
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div className="space-y-4">
                <Badge
                  variant="secondary"
                  className="border-border/40 w-fit rounded-none bg-background/80 px-3 py-1 text-xs tracking-[0.2em] text-foreground/70 uppercase "
                >
                  Featured case study
                </Badge>
                ...
                >
                  {avatarProfiles.map((profile) => (
                    <div
                      key={profile.src}
                      role="listitem"
                      className="border-border/50 relative size-11 overflow-hidden rounded-none border bg-background/80 transition-opacity duration-300 group-hover:opacity-80 "
                    >
                      <img
                        src={profile.src}
                        alt={profile.alt}
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group border-border/40 hover:border-border/60 col-span-1 flex h-full flex-col rounded-none border bg-background/70 p-6 backdrop-blur transition-all hover:shadow-lg sm:col-span-2 "
            role="article"
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group border-border/40 hover:border-border/60 relative col-span-1 overflow-hidden rounded-none border bg-background/70 backdrop-blur hover:shadow-lg sm:col-span-2 lg:row-span-3 "
            role="article"
          ...
          >
            ...
            <div className="relative flex h-full flex-col justify-end space-y-4 p-6 md:p-8">
              <Badge
                variant="outline"
                className="border-border/60 w-fit rounded-none bg-background/80 px-3 py-1 text-xs tracking-[0.2em] text-foreground/70 uppercase "
              >
                Behind the scenes
              </Badge>
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {['Micro-interactions', 'Depth cues', 'Narrative flow'].map(
                  (tag) => (
                    <span
                      key={tag}
                      className="border-border/40 rounded-none border bg-background/70 px-3 py-1 text-xs tracking-[0.18em] text-foreground/60 uppercase "
                    >
                      {tag}
                    </span>
                  ),
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group border-border/40 hover:border-border/60 col-span-1 flex h-full flex-col rounded-none border bg-background/70 p-6 backdrop-blur transition-all hover:shadow-lg sm:col-span-2 lg:row-span-2 "
            role="article"
          ...
          <motion.article
            ...
            whileHover={{ y: -4 }}
            transition={{ duration: 0.2 }}
            className="group border-border/40 hover:border-border/60 col-span-1 flex h-full flex-col overflow-hidden rounded-none border bg-linear-to-r from-primary/15 via-background/70 to-background/90 p-0 backdrop-blur transition-all hover:shadow-lg sm:col-span-2 "
            role="article"
              ...
              <div className="relative flex h-full flex-col justify-between bg-linear-to-r from-background/90 via-background/70 to-transparent p-6 md:p-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <Badge
                      variant="outline"
                      className="border-border/50 w-fit rounded-none bg-background/70 px-3 py-1 text-xs tracking-[0.2em] text-foreground/70 uppercase "
                    >
                      Motion showcase
                    </Badge>
                    <motion.div
          ...
          >
            <div className="space-y-3">
              <Badge
                variant="outline"
                className="border-border/50 w-fit rounded-none bg-background/70 px-3 py-1 text-xs tracking-[0.2em] text-foreground/60 uppercase "
              >
                Visual research
              </Badge>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {inspirationGallery.map((image) => (
                <div
                  key={image.src}
                  className="border-border/30 relative aspect-4/3 overflow-hidden rounded-none border bg-background/60 "
                >
                  <img
                    src={image.src}
                    alt={image.alt}
