...
export function LifeBriefBar() {
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border/80 bg-surface shadow-2xs transition-all duration-300">
        ...
        <div className="animate-in slide-in-from-top-2 space-y-6 border-t border-border bg-surface-subtle p-6 duration-300">
              ...
              {PERSONAS.map((p) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'relative flex flex-col justify-between gap-2 rounded-2xl border p-4 text-left transition-all duration-200',
                      isSelected
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between border-t border-border/50 pt-2 font-mono text-[11px] text-muted">
          ...
          <div className="text-caption flex flex-col items-center justify-between gap-4 rounded-2xl border border-sky-500/20 bg-gradient-to-r from-sky-500/10 via-purple-500/5 to-transparent p-4 text-ink sm:flex-row">
            ...
            <button
              ...
              className="shrink-0 rounded-lg bg-fjord px-4 py-1.5 text-xs font-bold text-white transition-colors hover:bg-fjord-hover"
            >
              Apply to Workspace
            </button>
          </div>
