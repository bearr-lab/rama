...
import { ArrowRight, Calculator, TrendingUp, ShieldCheck, PieChart } from 'lucide-react';
      ...
      <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
        ...
        <div className="space-y-6 lg:col-span-6">
          ...
          <div>
            ...
            <input
              ...
              className="mt-2.5 h-2 w-full cursor-pointer appearance-none rounded-lg bg-stone-200 accent-[#0a4e6e] dark:bg-stone-700"
            />
        ...
        <div className="rounded-xl border border-stone-200/60 bg-stone-50/80 p-6 lg:col-span-6 dark:border-stone-800 dark:bg-stone-950/60">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 rounded-lg border border-emerald-500/20 bg-emerald-50/40 p-4 dark:bg-emerald-950/20">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-emerald-600/10 px-2 py-0.5 text-[10px] font-semibold text-emerald-800 dark:text-emerald-300">
              ...
              <p className="mt-2 text-3xl font-extrabold text-emerald-800 dark:text-emerald-300">
                {formatCurrency(simulation.fiveYearEquityProjection)}
              </p>
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href={`/${locale}/invest`}
              className="inline-flex items-center justify-center rounded-md bg-[#0a4e6e] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#083b54] dark:bg-sky-600 dark:hover:bg-sky-700"
            >
