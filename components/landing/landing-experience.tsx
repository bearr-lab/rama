...
import { ArrowRight, Check, Compass, FileCheck2, MapPinned, Scale } from 'lucide-react';
...
const content = {
  en: {
    ...
    intro: 'RAMA brings listings, evidence and the decisions around them into one quiet, practical place.',
    explore: 'Explore homes',
    how: 'How it works',
    proofTitle: 'Clarity before momentum.',
    proofIntro: 'A smaller set of useful tools, designed to help you move with confidence — without creating more noise.',
    steps: [
      ['Discover with context', 'Search homes and communities with the details that matter to you.'],
      ['Review the evidence', 'Keep documents, pricing context and unanswered questions together.'],
      ['Decide deliberately', 'Compare your options and pick up exactly where you left off.'],
    ],
    workspace: 'Your decision space',
    workspaceText: 'A private workspace for shortlists, property notes, document review and the next useful action.',
    openWorkspace: 'Open workspace',
  },
  ar: {
    eyebrow: 'عقارات دبي، بوضوح',
    title: 'مساحة أهدأ لاتخاذ قرارك العقاري.',
    intro: 'يجمع راما العقارات والأدلة والقرارات المرتبطة بها في مكان واحد عملي وهادئ.',
    explore: 'استكشف العقارات',
    how: 'كيف يعمل',
    proofTitle: 'الوضوح قبل الاستعجال.',
    proofIntro: 'أدوات أقل وأكثر فائدة تساعدك على التقدم بثقة من دون ضجيج إضافي.',
    steps: [
      ['اكتشف ضمن سياقك', 'ابحث في العقارات والمجتمعات وفق التفاصيل التي تهمك.'],
    ...
    workspaceText: 'مساحة خاصة للقوائم المختصرة وملاحظات العقار ومراجعة المستندات والخطوة التالية المفيدة.',
        ...
        <Container size="lg" className="grid gap-12 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              <a href="#how-it-works" className={buttonVariants({ variant: 'outline', size: 'lg' })}>{t.how}</a>
            </div>
          </div>
