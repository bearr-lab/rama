              ...
              <div className="aspect-9/19 overflow-hidden rounded-none bg-background">
                ...
                <div className="flex h-full flex-col">
                  ...
                  <div className="flex items-center gap-3 bg-surface-subtle px-4 py-3">
                    <div className="flex size-8 items-center justify-center rounded-none bg-fjord">
                  ...
                  <div className="flex-1 space-y-4 overflow-hidden p-4">
                    ...
                    <div className="flex justify-end gap-2">
                      <div className="max-w-[85%] rounded-none bg-fjord px-4 py-3 text-white">
                        <p className="text-sm">
                  ...
                  <div className="border-t border-border px-4 py-3">
                    <div className="flex items-center gap-2 rounded-none bg-surface-subtle px-4 py-2">
                      <span className="flex-1 text-sm text-muted-foreground">
                        Type a message...
                      </span>
                      <div className="flex size-6 items-center justify-center rounded-none bg-fjord">
