    ...
    >
      ...
      >
        ...
        <div className="pointer-events-auto absolute inset-x-0 top-0 flex h-32 items-start justify-between bg-linear-to-b from-black/80 to-transparent p-6">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="h-10 border border-white/10 bg-fjord/40 text-white backdrop-blur-md hover:bg-fjord/80 backdrop-blur-md"
            >
              <Map className="mr-2 size-4" />
              {isFloorPlanMode ? 'View Photo' : 'Floor Plan'}
            </Button>

            <div className="flex rounded-md border border-white/10 bg-fjord/40 p-1 backdrop-blur-md">
              <button
            ...
            <Button
              onClick={onClose}
              variant="ghost"
              className="ml-4 size-12 rounded-full border border-white/20 bg-fjord/50 p-0 text-white shadow-2xl backdrop-blur-xl transition-transform hover:scale-105 hover:bg-fjord/80 backdrop-blur-md"
            >
              <X className="size-6" />
            </Button>
          </div>
        ...
        <div className="pointer-events-auto absolute bottom-8 left-1/2 -translate-x-1/2">
          <div className="flex items-center gap-2 rounded-full border border-white/10 bg-fjord/80 backdrop-blur-md p-1.5 shadow-2xl backdrop-blur-xl">
            {[
        ...
        {filteredImages.length > 1 && (
          <div className="pointer-events-none absolute inset-x-4 inset-y-0 flex items-center justify-between">
            <button
              onClick={prevImage}
              className="pointer-events-auto flex size-12 items-center justify-center rounded-full border border-white/10 bg-fjord/20 text-white backdrop-blur-md transition-all hover:bg-fjord/80 backdrop-blur-md"
            >
        ...
        <div className="pointer-events-auto absolute bottom-8 left-8 flex flex-col items-start gap-4">
          ...
          <div className="group relative">
            <button className="flex size-10 items-center justify-center rounded-full border border-white/10 bg-fjord/40 text-white/80 backdrop-blur-md transition-colors hover:text-white">
              <Compass className="size-5" />
            </button>
            <div className="absolute bottom-full left-0 mb-3 rounded-md border border-white/10 bg-fjord/80 backdrop-blur-md px-3 py-2 text-xs whitespace-nowrap text-white opacity-0 backdrop-blur-md transition-opacity group-hover:opacity-100">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {!isActive && (
                      <div className="pointer-events-none absolute top-full left-1/2 mt-2 -translate-x-1/2 rounded border border-white/20 bg-fjord/80 backdrop-blur-md px-2 py-1 text-[10px] font-bold whitespace-nowrap text-white opacity-0 shadow-lg backdrop-blur-md transition-opacity group-hover:opacity-100">
                  ...
                  {isActive && (
                    <div
                      className={cn(
                        'animate-in fade-in zoom-in-95 absolute z-30 w-64 rounded-xl border border-white/20 bg-fjord/70 p-4 shadow-2xl backdrop-blur-xl duration-200',
      ...
      {showHint && (
        <div className="animate-in fade-in pointer-events-none absolute inset-0 z-50 flex items-center justify-center duration-500">
          <div className="flex items-center gap-3 rounded-full border border-white/10 bg-fjord/80 backdrop-blur-md px-6 py-3 text-sm font-medium text-white/90 shadow-2xl backdrop-blur-md">
