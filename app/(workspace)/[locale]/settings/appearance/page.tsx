    ...
    <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          <div>
            ...
            <select 
              ...
              className="mt-2 block w-full rounded-none border border-border/60 bg-surface-subtle p-3 font-medium text-ink focus:border-stone-900 focus:ring-1 focus:ring-ink focus:outline-none"
            >
      ...
      <div className="shadow-subtle h-full rounded-none border border-border/60 bg-surface p-6">
        ...
        <div className="space-y-4">
          <div className="rounded-none border border-border/60 bg-white p-5 shadow-resting">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-1 border border-stone-900 bg-surface px-2 py-1 text-xs font-bold text-ink">
